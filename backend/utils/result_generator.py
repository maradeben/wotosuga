...
def generate_results(data):
    ...
    diag_plot = plots.plot_diag_by_bmi_sex(diag, data['Sex'])
    diag_plot.savefig('diag_.png', format='png')
    bmi_cat_plot = plots.plot_bmi_category(bmi)
    bmi_dist_plot = plots.plot_bmi_dist(bmi)
